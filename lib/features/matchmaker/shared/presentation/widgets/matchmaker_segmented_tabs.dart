...
/// Reusable segmented header: a soft-fill track with a sliding **wine pill**
/// under the active segment (RTL-correct via `AnimatedPositionedDirectional`).
/// The active label turns paper-white/800; the rest stay ink-muted. Used by
/// the Users tab (3 segments + a pending badge) and the Conversations tab
/// (2 segments). Tokenised on [QeranRadii] / [QeranShadows] — no raw literals.
class MatchmakerSegmentedTabs extends StatelessWidget {
  ...
  // Pill glide + label cross-fade. Same tokens as the content slide, so the
            ...
            Flexible(
              child: AnimatedDefaultTextStyle(
                ...
                style: QeranTypography.subtitle.copyWith(
                  fontSize: 14,
                  color: isActive ? QeranColors.paper : QeranColors.inkMuted,
