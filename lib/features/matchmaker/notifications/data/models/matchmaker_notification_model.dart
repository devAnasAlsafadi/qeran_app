...
class MatchmakerNotificationModel {
  ...
  const MatchmakerNotificationModel({
    required this.id,
  ...
  /// Decodes the JSON-string `data` field. Already-a-map (future shape) is
  ...
  MatchmakerNotification toEntity() => MatchmakerNotification(
        id: id,
        titleAr: titleAr,
        titleEn: titleEn,
        bodyAr: bodyAr,
        bodyEn: bodyEn,
        type: MatchmakerNotificationType.fromWire(type),
        data: data,
        createdAt: createdAt,
      );
}
