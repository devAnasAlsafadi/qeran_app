/// Defensive JSON parsers for the legal-documents models. Mirrors the
/// per-feature copies (e.g. `features/notifications/data/json_parsers.dart`)
/// — each module keeps its own copy so features stay decoupled. Tolerates
...
/// non-object entries. Used for the `sections: [...]` payload.
