...
///
/// Inked for a paper ground: the grid rides inside its own card on the roadmap
/// frame, matching the step strip on the essence frame, so the copy keeps
/// `inkBody` rather than the paper it would need on bare wine.
